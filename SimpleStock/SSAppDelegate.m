...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    SSMasterViewController *controller = (SSMasterViewController *)navigationController.topViewController;
...
- (void)insertStock{
    while (YES) {
        ...
        NSFetchRequest *fetch = [[NSFetchRequest alloc] initWithEntityName:@"Stock"];
        NSUInteger count = [self.managedObjectContext countForFetchRequest:fetch error:NULL];
        ...
        [newManagedObject setValue:[NSDate date] forKey:@"modifyTime"];
        [newManagedObject setValue:[NSString stringWithFormat:@"RenRen.Inc_%d",count + 1] forKey:@"name"];
        float random = (float)(arc4random()%100);
        [newManagedObject setValue:[NSNumber numberWithFloat:random] forKey:@"indicator"];
...
//    _managedObjectContext.stalenessInterval = 1;
    return _managedObjectContext;
}
...
- (NSManagedObjectModel *)managedObjectModel
{
    ...
    NSURL *modelURL = [[NSBundle mainBundle] URLForResource:@"SimpleStock" withExtension:@"momd"];
...
- (NSPersistentStoreCoordinator *)persistentStoreCoordinator
{
    ...
    NSURL *storeURL = [[self applicationDocumentsDirectory] URLByAppendingPathComponent:@"SimpleStock.sqlite"];
