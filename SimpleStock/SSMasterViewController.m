...
{
    SSStockViewController *stockViewController = [[SSStockViewController alloc] init];
...
{
    NSLog(@"rly ... numberOfSectionsInTableView");
    return [[self.fetchedResultsController sections] count];
}

- (NSInteger)tableView:(UITableView *)tableView numberOfRowsInSection:(NSInteger)section
{
    NSLog(@"rly ... numberOfRowsInSection");
...
{
    NSLog(@"rly ... cellForRowAtIndexPath %d",indexPath.row);
